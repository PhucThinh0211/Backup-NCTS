        ...
        <Row gutter={[8, 0]}>
          <Col xs={24} sm={12} md={6}>
            <Form.Item label="Giờ hàng về">
              <TimePicker style={{ height: "40px", borderRadius: 10, width: "100%" }} />
            </Form.Item>
          </Col>
          <Col xs={24} sm={12} md={6}>
            <Form.Item label="Ngày hàng về">
              <DatePicker style={{ height: "40px", borderRadius: 10, width: "100%" }} />
            </Form.Item>
          </Col>
          <Col xs={24} sm={12} md={6}>
        ...
        <Row gutter={[8, 0]}>
          <Col xs={24} sm={12}>
            <Form.Item label="Trọng lượng (kg)">
              <Input style={{ height: "40px", borderRadius: 10, width: "100%" }} />
            </Form.Item>
          </Col>
          <Col xs={24} sm={12}>
